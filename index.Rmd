...
### Alternative Hypothesis Trees: `Placental_Hypotheses.tree`
...
```{bash, comment=NA, echo=FALSE, class.output="bg_text"}
cat iqtree/hypothesis_trees/Placental_Hypotheses.tree
```
...
```{bash, comment=NA, echo=FALSE, class.output="bg_R"}
