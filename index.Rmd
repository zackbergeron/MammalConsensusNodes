...
* **Note:** AMAS takes file names as command line arguments with a limit on how long the line can be. In order to analyze several hundred thousand files, AMAS is run in batches by the driver script.
...
* adjust `12` to the number of cores you wish to use
```{bash, comment=NA, echo=FALSE, class.output="bg_slurm"}
