...
* (runs the python script `filter_SISRS_output.py`)
...
* runs the follown python scripts: `annotation_getTaxContigs.py`,`annotation_blast_parser.py`,`annotation_bed2table.py`
